...
import {AccountStructure, ChargeStructure} from "../src/types.ts";

const AccountViewEdit = () => {
    const { id } = useParams();
        ...
        const fetchData = async () => {
            try {
                ...
                if (accountSnap.exists()) {
                    ...
                    setAccount(accountData as AccountStructure);
                    setEditableAccount(accountData as AccountStructure);
    ...
    const handleAddressChange = (
        field: keyof AccountStructure["address"],
        value: string
    ) => {
    ...
    const handleSave = async () => {
        ...
        try {
            const accountRef = doc(db, "accounts", id);
            await setDoc(accountRef, editableAccount, { merge: true });
    ...
    return (
        <Container maxWidth="md" sx={{ mt: 5 }}>
            ...
            {/*TODO: Add click on charge to navigate to charge information.*/}
...
export default AccountViewEdit;
